# K2 Training Dashboard

#### **Purpose:** This site lists requirements, status, and resources for Keith's training. Provides links to my videos for instructor review and comment (coaching).

#### **Mission:** I am a returning martial arts dedicated to Kuk Sool training and the leadership of Master Sungjin Suh. Under the direction of SBN Toran Gordinier, I am focused on rebuilding my understanding and execution of WKSA curriculum with the goal of later extending to UMKS curriculum.


### Dan Bo Nim (1st Degree) → Requirements for 2nd Degree
...
## Kicking / Striking (Cha Ki / Soo Ki)
...
# Kyo Sa Nim (2nd Degree) → Requirements for 3rd Degree
...
| ---------------------------------------------- | ------ | --------------- | -------- | -------- | ------ |
| Johk Sool Kyuk Pah                             |        |                 |          |          |        |
| Sahm Bahng Cho Cha Ki                          |        |                 |          |          |        |
| Sahm Joong Cha Ki                              |        |                 |          |          |        |
| Di Uh Ee Joong Cha Ki (Ahp / Yup / Bahl Deung) |        |                 |          |          |        |

---

# Bu Sa Bum Nim (3rd Degree) → (Your current rank maintenance)

These are the foundational elements you should likely rebuild first before moving deeper into UMKS extensions.
...
# Recommendation for Your First Dashboard Version

Given Sungjin’s comments:

> **Low stances — Strong hands — High kicks**

I would suggest marking these rows as **Priority**:
...
These will expose **90% of the structural issues** Toran will want to correct.

---

# Suggestion for your OneNote implementation (fits your K2 Vault well)

Create a section:

**K2 Vault → Kuk Sool → Training**

Pages:

1. **Training Dashboard**
2. **Video Submissions**
3. **Toran Feedback Log**
4. **UMKS Principles (10 goals)**

This becomes your **personal training record** — something very few martial artists maintain.

---

If you'd like, I can also help you build something extremely useful for your long-term training:

**A “Kuk Sool Skill Tree”**
...
It becomes a **map of the entire system**, which fits perfectly with your research mindset and the Kuk Sool knowledge base you are building.
